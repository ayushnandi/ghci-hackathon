...
export default function DepositServices() {
  ...
  const processingDeposits = depositHistory.filter(
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <Card className="lg:col-span-2">
              <CardHeader>
                ...
                <CardDescription>
                  Your current deposit limits and usage
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium text-sm">
                          {limit.depositType.toUpperCase().replace("_", " ")} -{" "}
                          {limit.limitType.charAt(0).toUpperCase() +
                            limit.limitType.slice(1)}
                        </p>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Monthly deposit activity by type
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {depositHistory.slice(0, 10).map((deposit) => (
                  ...
                  >
                    <div className="flex-1 space-y-1">
                      ...
                      {deposit.expectedClearingDate &&
                        deposit.status !== "cleared" && (
                          <p className="text-xs text-muted-foreground">
                            Expected:{" "}
                            {formatDate(deposit.expectedClearingDate, "medium")}
                          </p>
                        )}
                      {deposit.memo && (
                      ...
                      <p className="text-xs text-muted-foreground">
                        Confirmation: {deposit.confirmationNumber}
                      </p>
                    </div>
                    <div className="text-right">
